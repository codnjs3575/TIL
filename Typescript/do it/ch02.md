...
- node.js 프로젝트 만든 다음, 개발 언어를 타입스크립트로 설정하는 방식
  ...
  - package.json 파일을 만들었으면 프로젝트 구현에 필요한 `오픈소스 패키지`를 `npm install` 또는 간단하게 `npm i` 명령으로 설치 가능
    ...
    - 다음처럼 두 가지 옵션을 줄 수 있음
      ...
      <img src="ch02.assets/image-20220531155122332.png" alt="image-20220531155122332" style="zoom:40%;" />
...
<img src="ch02.assets/image-20220531161812541.png" alt="image-20220531161812541" style="zoom:20%;" align='left'/>
<br>
<br>
<br>
