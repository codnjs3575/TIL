...
for (let i = 0; i < Arr.length; i++) {
  for (let j = 0; j < Arr.length; j++) {
    ...
    else if (Arr[i][j] !== Arr[i][j - 1] && Search1(i, j)) {
      console.log(Arr[i][j])
      console.log(i + 1, j + 1)
      return
    } else if (Arr[i][j] !== Arr[i - 1][j] && Search2(i, j)) {
      console.log(Arr[i][j])
      console.log(i + 1, j + 1)
      return
    } else if (Arr[i][j] !== Arr[i + 1][j - 1] && Search3(i, j)) {
      console.log(Arr[i][j])
      console.log(i + 1, j + 1)
      return
    } else if (Arr[i][j] !== Arr[i - 1][j - 1] && Search4(i, j)) {
      console.log(Arr[i][j])
      console.log(i + 1, j + 1)
      return
    }
